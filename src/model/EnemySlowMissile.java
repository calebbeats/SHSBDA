/*
    ...
    NOT WORKING NEED TO MESS WITH GAME DATA
...
public class EnemySlowMissile extends GameFigure {

    // missile size
    private static final int SIZE = 10;
    
    //Add Frozen "Explosion"
    private static final int MAX_ICE_SIZE = 3;
     ...
     */
    public EnemySlowMissile(float sx, float sy) {
        super(sx, sy);
        ...
        try {
            ...
            launcherImage = ImageIO.read(getClass().getResource("enemySlowMissile.png"));
    ...
    public void updateState() {
        if (state == STATE_ALIVE) {
            ...
            if (explosionCounter >= MAX_ICE_SIZE) {
                this.goNextState();
            }
        }
    }
